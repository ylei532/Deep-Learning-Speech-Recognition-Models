...
class Transformer(keras.Model):
    def __init__(
        ...
        self.model_name = 'TransformerModel1'
    ...
    def predict_text(self, batch, print_mode=True, metric=None):
        """Outputs the predictions of the words spoken in an audio file (as performed by self.generate()), and returns
        an accuracy metric value, either of 'bleu' or 'wer' """
